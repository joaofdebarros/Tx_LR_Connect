...
static const sl_cli_command_info_t cli_cmd__pjoin = \
  SL_CLI_COMMAND(cli_pjoin,
                 "Permit joining for a given time period with optional selective payload",
...
static const sl_cli_command_info_t cli_cmd__data = \
  SL_CLI_COMMAND(cli_data,
                 "Force sensor to send a report to the sink",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__set_report_period = \
  SL_CLI_COMMAND(cli_set_report_period,
                 "",
                  "Sensor report period in ms" SL_CLI_UNIT_SEPARATOR,
...
static const sl_cli_command_info_t cli_cmd__join_sleepy = \
  SL_CLI_COMMAND(cli_join_sleepy,
                 "Join as Sleepy End Device",
                  "Channel" SL_CLI_UNIT_SEPARATOR "Optional PAN ID" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT16, SL_CLI_ARG_UINT16OPT, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__join_extender = \
  SL_CLI_COMMAND(cli_join_extender,
                 "Join as Range Extender",
                  "Channel" SL_CLI_UNIT_SEPARATOR "Optional PAN ID" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT16, SL_CLI_ARG_UINT16OPT, SL_CLI_ARG_END, });
...
const sl_cli_command_entry_t sl_cli_default_command_table[] = {
  ...
  { "data", &cli_cmd__data, false },
  { "set_report_period", &cli_cmd__set_report_period, false },
